        ...
        <div>
          <RollStateList
            stateList={[
              ...
              { type: "present", count: students.filter(a => a.roll === "present").length },
              { type: "late", count: students.filter(a => a.roll === "late").length },
              { type: "absent", count: students.filter(a => a.roll === "absent").length },
            ]}
          />
